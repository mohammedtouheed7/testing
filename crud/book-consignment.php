									...
									<div class="sub-block">
										<form id="consignor">
											...
											<div id="supporting-document" class="disabled">
												...
												<a class="btn btn-primary" onclick="submitDetails()" name="submit" id="submit">Submit</a>
											</div>
										</form>
									</div>
								</div>
...
$(document).ready(function(){
	...
	$('#by-air h6').click(function(){
		var air = $('#by-air h6').text();
		alert(air);
	});
	$('#by-train h6').click(function(){
		var train = $('#by-train h6').text();
		alert(train);
	});
	$('#by-road-surface h6, #by-road-surface p').click(function(){
		var train = $('#by-road-surface h6, #by-road-surface p').text();
		alert(train);
	});
	$('#to-billed h6, #to-billed p').click(function(){
		var billed = $('#to-billed h6, #to-billed p').text();
		alert(billed);
	});
	$('#to-pay h6, #to-pay p').click(function(){
		var topay = $('#to-pay h6, #to-pay p').text();
		alert(topay);
	});
	$('#cod h6, #cod p').click(function(){
