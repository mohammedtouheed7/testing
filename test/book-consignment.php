						...
						<div class="block" id="select-customer">
							...
							<div class="row">
								<div class="col-sm-6 cust-padding-margin" id="new-cust">
									<div class="sub-block" id="a" name="customer">
										<h6>New Customer </h6>
							...
							<div class="row">
								<div class="col-sm-2 cust-padding-margin">
									<div class="sub-block" id="by-air">
										...
										<p> &nbsp; </p>
										<h6 >By Air</h6>
										<p id="new" style="display:none;">1</p>
								...
								<div class="col-sm-2 cust-padding-margin" >
									<div class="sub-block" id="by-train">
										...
										<p> &nbsp; </p>
										<h6>By Train</h6>
										<p id="new1" style="display:none;">2</p>
								...
								<div class="col-sm-12 cust-padding-margin">
									<div class="sub-block">
										<form id="consignor">
											...
											<div id="supporting-document" class="">
												<!-- <div class="details-hdr"> -->
...
$(document).ready(function(){
	...
	// 	alert(existing);
	// });
	$("#by-air").click(function(){
		//var a = $("#by-air h6").text();
		console.log("clicked");
	});
// 	$('#by-air').click(function(){
// 		var a = $("#by-air h6").text();
...
e.preventDefault();
	...
	// if($('#by-air.active #new p').text() !=''){
	// 	var air = $('#by-air #new p').text();
	// }else if($('#by-train.active #new1 p').text()!=''){
	// 	var train = $('#by-train #new1 p').text();
	// }else if($('#by-road-surface.active h6, #by-road-surface.active p').text()!=''){
	...
	$.ajax({
		...
		data:{customer:customer,existing:existing,air:air,train:train,roadsurface:roadsurface,roadexpress:roadexpress,
			localdelivery:localdelivery,tobilled:tobilled,topay:topay,cod:cod},
